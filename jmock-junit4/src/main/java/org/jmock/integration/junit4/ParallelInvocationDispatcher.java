...
public class ParallelInvocationDispatcher extends InvocationDispatcher {
    private final Map<Long, Double> threadResponseTimes = Collections.synchronizedMap(new HashMap<>());
    private final Map<Long, InvocationDispatcher> dispatcherMap = Collections.synchronizedMap(new HashMap<>());
    ...
    private InvocationDispatcher get() {
        ...
        return dispatcherMap.computeIfAbsent(threadId, k -> new InvocationDispatcher());
    }
